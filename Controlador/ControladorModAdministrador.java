 ...
 * @author User
 */
@WebServlet(name = "ControladorModAdministrador", urlPatterns = {"/ControladorModAdministrador"})
public class ControladorModAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean b = gp.modificarAdministrador(p1, p);
        ...
        RequestDispatcher a = request.getRequestDispatcher("resultadoModAdministrador.jsp");
